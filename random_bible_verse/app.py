...
app.layout = dbc.Container(
    [
        html.H1(
            "Random Bible Verse",
            className="text-center border-bottom border-primary pb-4 mb-4",
        ),
        html.H2(id="verse-text", className="text-center"),
        html.H2(
            id="verse-reference",
            className="text-center border-top border-primary pt-4 mt-4",
        ),
        dcc.Interval(
            id="interval", interval=settings.REFRESH_INTERVAL_MS, n_intervals=0
        ),
    ],
